...
Что нужно:
1. Изучить документацию на плагин JaCoCo (а конкретно на цель `check`)
...
1. Мы просили плагин выполнить цель report для генерации отчёта, вам нужно по аналогии с ним добавить ещё один execution, только не забыв заменить в нём report на check.
